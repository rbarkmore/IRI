...
C 2012.03 07/20/14 igrf_dip,FTPRNT,RECALC: ASIN(x): abs(x)>1.0 x=sign(1.,x)
C 2012.04 07/24/14 COMMON/iounit: added 'mess'
C 2012.05 02/10/15 Updating to IGRF-12 (2015)
C 2012.06 07/12/15 use mess,konsol in IGRF and RECALC
C 2012.07 04/16/18 Versioning now based on year of major releases
c-----------------------------------------------------------------------
C
