...
C 2012.01 07/24/14 COMMON/iounit/konsol, mess turn off messages
C 2012.02 12/22/14 TSELEC: SV(25),SVV(25)
C 2012.03 02/18/15 switches set (TSELEC) only in main not in GTD7,GLOBE7
C 2012.04 07/20/15 GLOB7S: P(150)->P(100)
C 2012.05 04/16/18 Versioning now based on year of major releases
C
